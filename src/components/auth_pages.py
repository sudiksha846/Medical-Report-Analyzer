...
def show_login_page():
    ...
    st.markdown(f"""
        <div style='text-align: center; padding: 2rem;'>
            ...
            <p style='font-size: 1.2em; color: #FB8C00; margin-bottom: 1em;'>{APP_TAGLINE}</p>
            <h3>{("   " if current_form == 'login' else "Welcome!")}</h3>
        </div>
    """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.markdown("---")
        toggle_text = " Sign up" if current_form == 'login' else " Login"
